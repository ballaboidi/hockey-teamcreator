<template>
  <div class="border-t py-8 grid grid-cols-1 lg:grid-cols-2 lg:gap-8">
    ...
    >
        <h2 class="text-2xl uppercase pb-3">Eingetragene Spieler:</h2>
        <div
    ...
    <div
      v-if="!teams"
      class="create-teams-btn uppercase lg:col-span-2 py-3 cursor-pointer rounded-md
    ...
    <div
      v-if="teams"
      class="recreate-teams-btn lg:col-span-2 uppercase py-3 cursor-pointer rounded-md 
